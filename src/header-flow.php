...
<link href="<?php echo get_template_directory_uri() ?>/css/prism.css">
<!-- links / End -->
...
/*.wc-field-name input[type="text"] {width: 100%;max-width: 100%;padding: 3px 5px;font-size: 14px;margin: 0;height: 29px}*/
/*
.wc-field-website input[type="url"], #wpcomm .wc-field-website input[type="text"] {width: 100%;max-width: 100%;padding: 3px 5px;font-size: 14px;margin: 0;height: 29px}
.wc-field-email input[type="email"] {width: 100%;max-width: 100%;padding: 3px 5px;font-size: 14px;margin: 0;height: 29px}
.wc-field-submit input[type="button"] {margin: 1px;border: #ddd 1px solid;font-size: 13px;line-height: 16px;padding: 6px 15px;clear: both;float: none}
*/
/*=======================================================*/
/*
#wp-comment-editor-container, #wp-comment-wrap{
