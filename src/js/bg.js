 $(function() {
				...
				var BlurBGImage	= (function() {
					...
					var $bxWrapper			= $('#bx-wrapper'),
						...
						animOptions			= { speed : 10000, variation : 2, blurFactor : 100 },
						...
						showImage			= function( pos ) {
							...
							if( supportCanvas ) {
								...
								$bxCanvas.css( 'z-index', 5 ).css('visibility','visible'); // was 100
							...
							// if canvas is not shown just work with the bg images
								...
								$.when( $bxNextImage.css( 'z-index', 7 ).fadeIn( animOptions.speed ) ).done( function() { //was 102
									
									current = pos;
									$bxImage.hide();
									$(this).css( 'z-index', 6 ); //was 101
									isAnim = false;
