        ...
        <div class="wrap">
            ...
            <form action="<?php echo admin_url('options.php') ?>" method="post" id="apfw_form">
                ...
                <p style="text-align: center">
                    <button class="button button-primary" type="submit" name="save_apfw_form" value="Save »"><i
                            class="dashicons-before dashicons-upload"> </i>Save Settings
                    </button>
                </p>
                <div id="poststuff">
    ...
    function apfw_admin_inline_style($hook)
    {
        if ($this->apfw_check_if_btn_can_be() == true) {
            ...
            <style type="text/css"> .mce-i-apfw-icon:before {
                    content: '\f499'; font: 400 20px/1 dashicons; padding: 0; vertical-align: top; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;
                } </style>
            <?php
        }
    }
