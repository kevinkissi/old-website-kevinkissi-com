...
> Download here : [https://wordpress.org/plugins/ank-prism-for-wp/](https://wordpress.org/plugins/ank-prism-for-wp/)
...
6. You can always download it from WordPress plugin directory 
